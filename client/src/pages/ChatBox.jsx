      ...
      <div className="flex flex-col h-screen">
            ...
            {messages
              ...
              .map((message, index) => (
                ...
                >
                  <div
                    className={`flex flex-col ${
                      message.to_user_id !== message._id
                        ? "rounded-bl-none"
                        : "rounded-br-none"
                    }`}
                  >
        ...
        <div className="px-4">
              ...
              max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
                ...
                <label htmlFor="image">
                  {
                    image ? <img src={URL.createObjectURL(image)} className="h-8 rounded" /> : <ImageIcon className="size-7 text-gray-400 cursor-pointer" />
                  }
                  <input type="file" id="image" accept="image/*" hidden onChange={(e) => setImage(e.target.files[0])} />
                </label>
                <button onClick={sendMessage} className="bg-gradient-to-br
                from-indigo-500 to-purple-600 hover:mask-b-from-indigo-700 hover:mask-b-to-purple-800
