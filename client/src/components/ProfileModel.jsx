        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile} action="">
            <div className="flex flex-col items-start gap-3">
              ...
              border border-gray-200 rounded-lg"
                ...
                <div className="group/profile relative">
                  ...
                  />
                  <div
                    className="absolute hidden group-hover/profile:flex top-0 bottom-0 left-0 right-0
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              >
                ...
                <div className="group/cover relative">
                  ...
                  top-0 bottom-0 left-0 right-0 bg-black/20 rounded-lg
            ...
            <div className="flex justify-end space-x-3 pt-6">
                <button onClick={() => setShowEdit(false)} type="button" className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700
